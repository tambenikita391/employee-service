...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Autowired
	EmplyeeRepoForSearch employeeRepoForSearch;
	...
	public EmployeeResponse saveEmployeeDetails(EmployeeRequest request) {
		...
		Employee employee = Employee.getInstance().setFullName(request.getFullName()).setPosition(request.getPosition())
				.setGender(request.getGender()).setSalary(request.getSalary()).setPhone(request.getPhone())
				.setAge(request.getAge()).seteMail(request.geteMail());
